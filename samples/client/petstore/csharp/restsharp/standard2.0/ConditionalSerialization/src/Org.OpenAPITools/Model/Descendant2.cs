    ...
    public partial class Descendant2 : TestDescendants, IEquatable<Descendant2>, IValidatableObject
    {
        ...
        public string Confidentiality
        {
            ...
            set
            {
                ...
                _flagConfidentiality = true;
            }
        }
        private string _Confidentiality;
        private bool _flagConfidentiality;

        /// <summary>
        /// Returns false as Confidentiality should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeConfidentiality()
        {
            return _flagConfidentiality;
        }
        /// <summary>
