...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class FormatTest : IEquatable<FormatTest>, IValidatableObject
    {
        ...
        public FormatTest(Option<int> integer = default, Option<int> int32 = default, Option<int> int32Range = default, Option<long> int64Positive = default, Option<long> int64Negative = default, Option<long> int64PositiveExclusive = default, Option<long> int64NegativeExclusive = default, Option<uint> unsignedInteger = default, Option<long> int64 = default, Option<ulong> unsignedLong = default, decimal number = default, Option<float> varFloat = default, Option<double> varDouble = default, Option<decimal> varDecimal = default, Option<string> varString = default, byte[] varByte = default, Option<FileParameter> binary = default, DateOnly date = default, Option<DateTime> dateTime = default, Option<Guid> uuid = default, string password = default, Option<string> patternWithDigits = default, Option<string> patternWithDigitsAndDelimiter = default, Option<string> patternWithBackslash = default, Option<decimal> stringFormattedAsDecimal = default, decimal stringFormattedAsDecimalRequired = default, Option<string> duplicatePropertyName2 = default, Option<string> duplicatePropertyName = default)
        {
        ...
        */
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                hashCode = (hashCode * 59) + this.Int32Range.Value.GetHashCode();
                }
                if (this.Int64Positive.IsSet)
                {
                hashCode = (hashCode * 59) + this.Int64Positive.Value.GetHashCode();
                }
                if (this.Int64Negative.IsSet)
                {
                hashCode = (hashCode * 59) + this.Int64Negative.Value.GetHashCode();
                }
                if (this.Int64PositiveExclusive.IsSet)
                {
                hashCode = (hashCode * 59) + this.Int64PositiveExclusive.Value.GetHashCode();
                }
                if (this.Int64NegativeExclusive.IsSet)
                {
                hashCode = (hashCode * 59) + this.Int64NegativeExclusive.Value.GetHashCode();
                }
                ...
                {
                hashCode = (hashCode * 59) + this.StringFormattedAsDecimal.Value.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.StringFormattedAsDecimalRequired.GetHashCode();
                if (this.DuplicatePropertyName2.IsSet && this.DuplicatePropertyName2.Value != null)
                {
                    hashCode = (hashCode * 59) + this.DuplicatePropertyName2.Value.GetHashCode();
                }
                if (this.DuplicatePropertyName.IsSet && this.DuplicatePropertyName.Value != null)
                {
                    hashCode = (hashCode * 59) + this.DuplicatePropertyName.Value.GetHashCode();
                }
