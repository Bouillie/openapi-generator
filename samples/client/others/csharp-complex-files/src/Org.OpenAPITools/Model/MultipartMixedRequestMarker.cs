...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MultipartMixedRequestMarker : IEquatable<MultipartMixedRequestMarker>, IValidatableObject
    {
        ...
        public MultipartMixedRequestMarker(Option<string> name = default)
        {
            // to ensure "name" (not nullable) is not null
            if (name.IsSet && name.Value == null)
            {
                throw new ArgumentNullException("name isn't a nullable property for MultipartMixedRequestMarker and cannot be null");
            }
            this.Name = name;
        }
